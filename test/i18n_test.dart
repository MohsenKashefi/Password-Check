  ...
  group('Internationalization Tests', () {
    ...
    group('PasswordChecker with i18n', () {
      ...
      test('should use German messages when specified', () {
        ...
        expect(result.errors, contains('Das Passwort muss mindestens 8 Zeichen lang sein'));
      });
      ...
      test('should use Persian messages when specified', () {
        ...
        expect(result.errors, contains('رمز عبور باید حداقل 8 کاراکتر باشد'));
      });
      ...
      test('should use custom messages when provided', () {
        ...
        expect(result.errors, contains('Custom minimum length message'));
      });
      ...
      test('should use localized strength level names', () {
        ...
        expect(result.strengthLevel.getLocalizedDisplayName(checker.messages), 
               contains('Fuerte'));
      });

      test('should work with auto language detection', () {
      ...
      test('should work with localized constructor', () {
        final checker = PasswordChecker.localized(language: 'es');
        final result = checker.validate('short');
